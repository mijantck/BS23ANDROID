package com.example.bs23android.data.model;
...
public class RepositoryModel {
    ...
    public class Item implements Parcelable {
        ...
        protected Item(Parcel in) {
            ...
            byte tmpHasDiscussions = in.readByte();
            hasDiscussions = tmpHasDiscussions == 0 ? null : tmpHasDiscussions == 1;
            if (in.readByte() == 0) {
                forksCount = null;
            } else {
            ...
            byte tmpAllowForking = in.readByte();
            allowForking = tmpAllowForking == 0 ? null : tmpAllowForking == 1;
            byte tmpIsTemplate = in.readByte();
            isTemplate = tmpIsTemplate == 0 ? null : tmpIsTemplate == 1;
            byte tmpWebCommitSignoffRequired = in.readByte();
            webCommitSignoffRequired = tmpWebCommitSignoffRequired == 0 ? null : tmpWebCommitSignoffRequired == 1;
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeByte((byte) (hasDiscussions == null ? 0 : hasDiscussions ? 1 : 2));
            if (forksCount == null) {
                dest.writeByte((byte) 0);
            } else {
                dest.writeByte((byte) 1);
            ...
            dest.writeByte((byte) (allowForking == null ? 0 : allowForking ? 1 : 2));
            dest.writeByte((byte) (isTemplate == null ? 0 : isTemplate ? 1 : 2));
            dest.writeByte((byte) (webCommitSignoffRequired == null ? 0 : webCommitSignoffRequired ? 1 : 2));
